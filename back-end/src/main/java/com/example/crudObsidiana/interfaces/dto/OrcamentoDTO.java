...
public class OrcamentoDTO {
    ...
    public List<UsoEquipamentoDTO> getUsosEquipamentos()                       { return usosEquipamentos; }
    public void   setUsosEquipamentos(List<UsoEquipamentoDTO> usosEquipamentos){ this.usosEquipamentos = usosEquipamentos; }
}